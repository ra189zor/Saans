...
export const ur = {
  ...
  guide: {
    ...
    alt: {
      ...
      respiratoryRate:
        'لیٹا ہوا بچہ ایک سانس کے دوران: سانس اندر لیتے ہوئے سینہ اور پیٹ اوپر اٹھتے ہیں، پھر سانس باہر نکالتے ہوئے نیچے بیٹھ جاتے ہیں۔',
      respiratoryRateDetail:
        'سکون سے بیٹھا ہوا بچہ، جس کے سینے کے اندر باہر ہونے کو ایک تیر سے دکھایا گیا ہے — یہ ایک سانس ہے۔',
    },
  },
