...
export default function AgeGateScreen({ lang, onLangChange, onSubmit, onBack }) {
        ...
        <main className={`${COLUMN} flex flex-1 flex-col pt-6 md:pt-10`}>
          ...
          <div className="flex flex-1 flex-col justify-center py-8">
            ...
            <div className="mt-8 flex items-center gap-4 md:mt-10">
              ...
              />
              <span className="text-xl text-muted md:text-2xl">years</span>
            </div>
            ...
            >
              Enter age in completed years. Use 0 for infants under one year.
            </p>
          </div>
        </main>
